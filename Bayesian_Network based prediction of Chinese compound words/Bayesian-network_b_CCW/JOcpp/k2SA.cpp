...
//		}
//
//		//cout << "SUMCNT更改前："<< curCPtable[convalue].sumcnt << endl;
//		curCPtable[convalue].sumcnt++;
//		//cout << "SUMCNT更改后：" << curCPtable[convalue].sumcnt << endl;
//
//		//cout << "CNT更改前：" << curCPtable[convalue].curCPtableI[value[id]].cnt << endl;
//		curCPtable[convalue].curCPtableI[value[id]].cnt++;
//		//cout << "CNT更改后：" << curCPtable[convalue].curCPtableI[value[id]].cnt << endl;
//
//	}
//
//}
...
//}
//
//double k2(int limit, vector<int> curorder)
//{
//	double totalscore = 0;
...
//	while (true)
//	{
//		a = rand() % curorder.size();
//		b = rand() % curorder.size();
//		if (a != 0 && b != 0 && a != b)
//		{
//			break;
//		}
...
//	for (int i = 1; i <= n; i++)
//	{
//		Pre[curorder[i]].clear();
//		for (int pi = 1; pi < i; pi++)
//		{
//
//			Pre[curorder[i]].insert(curorder[pi]);
//		}
//	}
//
//	return curorder;
...
//
////模拟退火
//void simulated_annealing(int limit)
//{
//	double MAXP = k2(limit, order);
//	double t = T;
//
//	double curP;
//	double deltaE;
...
//			break;
//		
//		cout << "//////////////////////////////模拟退火第" << cnt++ << "轮////////////////////////////////////" << endl;
//
//		vector<int> curorder = swap_order();
//		curP = k2(limit, curorder);
//
//		deltaE = curP - MAXP;
//		if (deltaE > 0)
//		{
